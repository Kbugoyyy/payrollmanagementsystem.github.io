...
<head>
  ...
  <link rel="icon" href="admin/img/PIF.png">
...
<body style="background-image: linear-gradient(180deg, yellow, green);" class="hold-transition login-page">
  <div class="text-center">
          <img src="admin/img/PIF.png"
               width="200">
        </div>
<div style="color: white;" class="login-box">
  ...
  <!-- /.login-logo -->
  <div class="card">
    <div style="background-color: yellowgreen;" class="card-body login-card-body">
      <p class="login-box-msg text-light">Enter Employee ID</p>
